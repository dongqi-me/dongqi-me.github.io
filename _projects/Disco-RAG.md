...
<span style="color: #800000;">@article</span>{<span style="color: #000080;">liu2025discorag</span>,
  ...
  <span style="color: #008000;">booktitle</span>={<span style="color: #000080;">Proceedings of the 64th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)</span>},
  <span style="color: #008000;">year</span>={<span style="color: #000080;">2026</span>}
}</pre>
  <button onclick="copyBibTeXDiscoRAG()" style="position: absolute; top: 10px; right: 10px; background: #f6f8fa; color: #24292e; border: none; border-radius: 6px; padding: 6px 10px; cursor: pointer; font-size: 12px; display: flex; align-items: center; opacity: 0.6; transition: opacity 0.2s;">
